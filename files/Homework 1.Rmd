...
After analyzing the google trends volume of "dolar" word in Turkey, I found that there is no leading quality of citizens interest over USDTRY currency. However, extreme movements in currency cause some extreme interest in people and caught their attention. For instance, in the middle of 2018 currency shock, the sentiment went to extreme territory rapidly. It might be reasonable due to effect of USDTRY in CPI (explained before). Also, a considerable number of people invest in Us Dollar as a speculative purposes. Thus, extreme volatility caught their interest.    

Moreover, if we ignore the unusual observations, there is a clear level difference between the first and second half of sample. It can be explained by the increasing volatility in USDTRY.